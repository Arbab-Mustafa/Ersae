  ...
  return (
    <section className="bg-black">
      <div className="mx-auto max-w-screen-xl  px-4 py-20 flex-col gap-2 sm:gap-4 flex h-screen items-center">
        <h2 className="text-center border border-whites w-fit text-white rounded-full py-2 px-3">
          See what's new | <span className="text-[#94DBFF]"> AI Diagram</span>
        </h2>
        <div className="mx-auto max-w-2xl text-center leading-relaxed py-2 md:py-3">
